...
export const TraceHero: React.FC<TraceHeroProps> = ({
	...
	return (
		<div
			className={`firefly-hero-container ${isBursting ? "pulse-flash" : ""} ${isBooting ? "booting" : ""} ${isExiting ? "exiting" : ""}`}
		>
			...
			<div className="firefly-stage" ref={stageRef}>
				...
				>
					<path
						d="M 520,380 L 610,290"
						className="hud-guide-line"
						fill="none"
					/>
					<path
						d="M 500,440 L 430,540"
						className="hud-guide-line"
						fill="none"
					/>
				</svg>
