...
function writeDataset(repos: TestRepo[]): void {
  ...
  console.log(`🎯 Expected overall accuracy at 0.7 threshold: ~${expectedAccuracy.toFixed(1)}%\n`);
}

// Main execution
console.log('🔧 Generating calibration dataset for session-to-commit linking...\n');
