...
type AppContentProps = {
	...
	surfaceAction:
		| import("./ui/views/narrativeSurfaceData").SurfaceAction
		| undefined;
			...
			return (
				<div className="p-8 flex flex-col h-full overflow-hidden">
					...
					<div className="flex-1 grid grid-cols-2 gap-12 opacity-50">
						<div>
							<div className="mb-4 text-xs font-semibold text-text-muted uppercase tracking-wider">
								Loading intents...
							</div>
			...
			return (
				<BranchView
					...
					onAuthorizeCodexAppServerForLiveTest={
						autoIngest.authorizeCodexAppServerForLiveTest
					}
