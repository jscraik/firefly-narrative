import type { TraceRecord, TraceContributorType } from '../types';

const CONTRIBUTOR_TYPES: TraceContributorType[] = ['human', 'ai', 'mixed', 'unknown'];

export function isContributorType(value: string): value is TraceContributorType {
  return CONTRIBUTOR_TYPES.includes(value as TraceContributorType);
}

export function normalizeContributorType(value: string | undefined): TraceContributorType {
