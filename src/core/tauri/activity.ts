...
export async function getCommitCaptureBundle(repoId: number, repoRoot: string, commitSha: string) {
  return invoke<CommitCaptureBundle>('get_commit_capture_bundle', { repoId, repoRoot, commitSha });
}
