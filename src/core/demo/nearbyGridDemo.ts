      ...
      messages: [
        {
          ...
          role: 'user',
          text:
            "Create a ProfileCard component showing the user's main photo, online status, distance, and age. Add a gradient overlay at the bottom. On tap, expand to show more photos."
        },
        {
          id: 'm2',
          role: 'assistant',
          text:
            "I'll create ProfileCard.vue with the photo display, online indicator dot, and gradient overlay. I'll add a touch handler to expand and reveal the photo carousel.",
        ...
        },
        {
          ...
          role: 'user',
          text:
            "The distance shows in meters but I need feet when <1000ft, miles otherwise. Also add 'Online now' text for users active in last 5 min."
        },
        {
          id: 'm4',
          role: 'assistant',
          text:
            "I'll update the distance formatter in utils/distance.ts and add the online recency logic to the indicator component.",
        ...
        },
        {
          ...
          role: 'user',
          text:
            'Perfect. One more thing - can you add a subtle pulsing animation to the online indicator when the user is currently active?'
        }
      ]
    }
  ],
...
`
  ...
  timeline: [
    { id: 't0', type: 'milestone', label: 'Branch created', status: 'ok', atISO: '2026-01-17T10:00:00Z' },
    {
      id: 't1',
      type: 'milestone',
