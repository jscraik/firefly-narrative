        ...
        <div className="card p-5">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <div className="section-subheader mt-0.5">Control attribution metadata caching and overlays.</div>
                </div>
            ...
            <div className="mt-4 flex flex-col gap-3 rounded-lg border border-border-light bg-bg-secondary p-4">
                <div className="flex items-center justify-between py-1">
                    <span className="text-xs text-text-secondary">Cache prompt metadata locally</span>
                    <Toggle
                ...
                <div className="flex items-center justify-between py-1">
                    <span className="text-xs text-text-secondary">Show line overlays in Source Lens</span>
                    <Toggle
