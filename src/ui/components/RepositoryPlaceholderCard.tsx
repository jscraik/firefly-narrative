      ...
      {onOpenRepo && (
        ...
        >
          <button
            type="button"
            onClick={onOpenRepo}
            className="inline-flex items-center gap-2 rounded-lg bg-surface-strong px-6 py-2.5 font-medium text-text-inverted shadow-lg shadow-bg-page/10 transition duration-200 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] active:scale-[0.98] hover:bg-surface-strong-hover hover:scale-105"
          >
            Open Repo Evidence
