    ...
    <div className="rounded-xl border border-accent-red-light bg-accent-red-bg p-4 text-sm">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          {help ? (
            <>
              <div className="font-semibold text-text-primary mb-1">{help.title}</div>
              <div className="text-text-secondary mb-3 leading-relaxed">{help.description}</div>
                  ...
                  {help.actions.map((action) => {
                    ...
                    action.href ? (
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-bg-card border border-accent-red-light text-accent-red text-xs font-medium hover:bg-bg-hover transition-colors"
                      >
