 ...
 *
 * Answers "what changed, and how grounded is the story?" at a glance:
 * commit count, file count, evidence confidence, and the narrative headline.
 */
export function BranchSummaryBar({
    ...
    return (
        ...
        <div className="flex items-center gap-2 text-xs text-text-muted">
            <span className="inline-flex items-center gap-1 rounded-md border border-accent-blue-light bg-accent-blue/10 px-2 py-0.5 font-semibold text-accent-blue">
                Repo Evidence
            </span>
                ...
                <>
                    ...
                    <div className="flex items-center gap-1.5">
                        ...
                        <span className="text-[0.625rem] font-bold uppercase tracking-wider text-text-tertiary">
                            Evidence confidence {Math.round(model.narrative.confidence * 100)}%
                        </span>
                    </div>
                </>
            )}
