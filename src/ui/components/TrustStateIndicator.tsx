...
export type TrustState = 'none' | 'hydrating' | 'replaying' | 'live_trusted' | 'trust_paused';
...
export function TrustStateIndicator(props: TrustStateIndicatorProps) {
  ...
  const canRetry = trustState === 'trust_paused' && activeThreadId !== null && onRetryHydrate;
  const canClearStale =
    trustState === 'trust_paused' && activeThreadId !== null && onClearStaleState;
