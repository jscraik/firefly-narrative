  ...
  return (
    <div className="mt-3 rounded-lg border border-accent-green-light bg-accent-green-bg/50 overflow-hidden">
      <button
        ...
        className="w-full flex items-center justify-between px-3 py-2 text-xs font-medium text-accent-green hover:bg-accent-green-bg/70 transition duration-200 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] active:duration-75 active:scale-[0.98]"
      >
      ...
      {hiddenCount > 0 && (
        <div className="mt-4 flex flex-col items-center justify-center gap-2 sm:flex-row">
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-bg-primary text-text-secondary text-xs font-medium hover:bg-border-light transition duration-200 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] active:duration-75 active:scale-[0.98] hover:scale-105"
          >
            {showAll ? (
              <><ChevronUp className="w-3.5 h-3.5" /> Show less</>
            ) : (
          ...
          {!showAll ? (
            <button
              ...
              className="inline-flex items-center gap-2 px-3 py-2 rounded-lg border border-border-light text-xs font-medium text-text-secondary hover:bg-bg-tertiary transition duration-200 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] active:duration-75 active:scale-[0.98] hover:scale-105"
            >
              Jump to latest
            </button>
          ) : null}
