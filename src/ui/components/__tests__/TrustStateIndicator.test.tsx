...
import { TrustStateIndicator, TrustStateCompact, type TrustState } from '../TrustStateIndicator';
...
describe('TrustStateIndicator', () => {
  ...
  describe('trust_paused recovery affordances', () => {
    ...
    it('shows approvals disabled message', () => {
      ...
      expect(screen.getByText('Approvals are disabled until trust is restored')).toBeInTheDocument();
    });
  });
