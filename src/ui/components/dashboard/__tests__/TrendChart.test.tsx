...
describe('TrendChart', () => {
    beforeEach(() => {
        ...
        window.getComputedStyle = vi.fn((() => ({
            getPropertyValue: (variableName: string) => createThemeVariables(mockTheme)[variableName as keyof ReturnType<typeof createThemeVariables>] ?? '',
    ...
    it('recomputes chart colors when the theme changes', () => {
        ...
        expect(mockSetOption).toHaveBeenLastCalledWith(expect.objectContaining({
