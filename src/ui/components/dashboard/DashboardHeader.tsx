          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none bg-bg-page hover:bg-bg-hover text-text-secondary text-sm font-medium rounded-md pl-3 pr-8 py-1.5 transition-colors cursor-pointer focus:outline-none focus:ring-2 focus:ring-accent-blue focus:ring-offset-2 focus:ring-offset-bg-card"
              >
