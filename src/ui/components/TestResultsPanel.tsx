        ...
        <div className="mt-5 flex flex-col items-center text-center py-3">
          ...
          {selectedCommitSha && onImportJUnit ? (
            <button
              ...
              disabled={loading}
              className="mt-4 inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-bg-primary text-text-secondary hover:bg-border-light transition-all duration-200 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] active:duration-75 active:scale-95 hover:scale-105 disabled:opacity-60 disabled:cursor-not-allowed"
            >
              Import JUnit XML…
            </button>
          ) : null}
