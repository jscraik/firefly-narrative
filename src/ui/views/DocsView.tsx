...
function isTauriRuntime(): boolean {
	...
	return Boolean(
		tauriWindow.__TAURI_INTERNALS__?.invoke || tauriWindow.__TAURI_IPC__,
	);
}
				...
				<div className="flex max-w-sm flex-col items-center gap-4 rounded-2xl border border-border-light bg-bg-secondary px-8 py-10 text-center shadow-sm">
					...
					<div>
						...
						<p className="text-sm leading-relaxed text-text-secondary">
							The Docs view needs access to your local file system to generate
							documentation. Please open Trace Narrative in the desktop app to
							use this feature.
						</p>
					</div>
				</div>
