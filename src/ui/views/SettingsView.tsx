    ...
    <div className="flex items-center justify-between gap-4 rounded-xl border border-transparent hover:border-border-subtle bg-transparent hover:bg-bg-secondary/50 p-3 transition-colors">
      ...
      <button
        ...
        className={clsx(
          ...
          checked ? 'bg-accent-violet' : 'bg-bg-tertiary hover:bg-border-subtle'
        )}
        role="switch"
      ...
      >
        <span
          ...
          className={clsx(
            ...
            checked ? 'translate-x-[1rem] border-bg-primary' : 'translate-x-0 border-border-strong'
          )}
        />
      </button>
    </div>
          ...
          <SettingsSection icon={FolderGit2} title="Scan Roots" description="Directories where Trace attempts to automatically discover and index repositories. Search depth is limited to 3 levels.">
            <div className="flex flex-col gap-2">
              <div className="flex items-center justify-between rounded-lg border border-border-subtle bg-bg-primary p-3 shadow-xs">
                <span className="text-sm font-mono text-text-secondary">~/dev/</span>
                <span className="rounded-md bg-accent-green-bg/50 px-2 py-0.5 text-[0.6875rem] font-medium text-accent-green border border-accent-green/20">ACTIVE</span>
              </div>
              <div className="flex items-center justify-between rounded-lg border border-border-subtle bg-bg-primary p-3 shadow-xs">
