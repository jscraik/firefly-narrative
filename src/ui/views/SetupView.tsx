		...
		>
			...
			<div className="flex items-center gap-3">
				...
				{severity !== "info" && (
					<button
						type="button"
						className="rounded-lg bg-bg-primary border border-border-light px-3 py-1.5 text-xs font-medium hover:bg-bg-secondary transition duration-200 ease-out active:duration-75 active:scale-[0.98]"
					>
						Review
					</button>
				)}
								...
								<div className="flex flex-col gap-3">
									...
									<div className="mt-4 rounded-xl border border-border-light bg-bg-primary p-4">
										...
										<p className="mt-1 text-xs leading-5 text-text-secondary">
											Codex agents have limited auto-approval for
											non-destructive filesystem reads in this workspace.
										</p>
									</div>
								</div>
							</Section>
