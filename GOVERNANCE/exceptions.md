...
- Add an exception before merging any bypass.
- Every entry must include owner, risk, mitigation, review date.
- Track closeout in this register and link to corresponding issue/PR.
